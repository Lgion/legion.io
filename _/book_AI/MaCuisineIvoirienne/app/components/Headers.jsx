...
import GlobalContext from "../../assets/utils/GlobalProvider"
...
export function HeadersDoubleSimple__MaCuisineIvoirienne({children,bem="B5-Headers",align="maCuisineIvoirienne",modifier="doubleHeader"}) {
    let $datas = {
        logo: ["/","Un doux tropic épicé en bouche","logo.png"]
        , navLinks: ["/","Un doux tropic épicé en bouche"]
        , list: [
        ]
    }
    , [href,slogan,imgSrc] = $datas.logo
    , {atts} = useContext(GlobalContext)
    atts = atts(bem,align,modifier)
    ...
    return <>
        <header {...atts}>
            ...
            {/* <LogSignInOutClerk />  */}
            <button>
                <img src="img/user_account_icon.png" alt="loginout buttons" />
                <LogSignInOut /> 
            </button>
            <nav>
                <Logo01 {...{href,slogan,imgSrc,wh:"150:100"}} />
                <form>
